# Azure MCP PostgreSQL Server Demo Changelog

<a name="1.0.0"></a>
## 1.0.0 (2025-10-15)

*Features*
* Initial release of Azure MCP PostgreSQL Server Demo
* Self-hosted MCP server on Azure Container Apps (ACA) with Managed Identity
...
* Web-based MCP client for testing (`mcp-client.html`)
...
*Initial Components*
* Azure MCP PostgreSQL Server (.NET 8.0)
* AI Foundry Agent client with Managed Identity authentication
* PostgreSQL database integration with Entra ID
* Deployment automation scripts and Bicep templates
